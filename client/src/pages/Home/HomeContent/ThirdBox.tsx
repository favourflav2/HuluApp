...
import { openTvItemDetails } from "../../../redux/features/huluSlice";
 ...
 function ThirdBox() {
  const { data, isFetching, error } = useGetTvByIdQuery(1399);
      ...
      <div className="w-full h-auto flex">
        <div className=" relative w-full h-auto">
          <img
            ...
            alt=""
            className="imgShadow brightness-50 hue-rotate-15 object-cover w-[100%]  lg:h-[650px] xl:h-[780px] 2xl:h-[820px] h-[550px]"
          />

          {/* Desktop Content */}
          <div className="w-auto px-5 py-2 h-auto  absolute  md:bottom-[120px] md:left-10 md:flex hidden  flex-col firstBox">
            {/* Title */}
            <h1 className="text-white mb-3">BASED ON MY FAVORITE TV SHOW</h1>

            {/* Show Title */}
            <div className="w-auto flex flex-col h-auto text-white mb-2">
              <h1 className="flex text-sm">HBO</h1>
